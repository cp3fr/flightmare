...
# Drop attention branching model.
...
model_dict={
    'img':'RGB Images',
    'ftstr': 'Feature Tracks',
    'encfts': 'Attention Prediction',
}

# Plot success rate as function of gates passed.
for dataset in ['train','test']:
    ...
    plt.grid(axis='y')
    plt.tight_layout()
    plt.savefig(path['perf']/'plots'/('success_rate_{}.png'.format(dataset)))
    plt.close(plt.gcf())
