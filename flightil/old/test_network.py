...
def test():
    ...
    trajectories = [
        ...
        "/home/simon/dda-inputs/trajectory_s016_r05_flat_li01_buffer20.csv",
    ]
    ...
    model_load_path = "/home/simon/gazesim-data/fpv_saliency_maps/logs/2021-03-23_13-06-06_resnet-larger-fm-mpc-da-nca/checkpoints/epoch004.pt"
    ...
    writer = cv2.VideoWriter(
        "/home/simon/Desktop/flightmare_cam_test/failed_offline_trained_performance.mp4",
    ...
    if show_plots:
        ...
        trajectory, _ = ensure_quaternion_consistency(trajectory)
