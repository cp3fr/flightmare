...
def test():
    ...
    model_load_path = model_load_paths[-8]
    settings_path = settings_paths[-8]
    ...
    experiment_path = "/home/simon/Desktop/weekly_meeting/meeting21/attention_labels_mpc"
    experiment_path = "/home/simon/Desktop/weekly_meeting/meeting21/attention_labels_reference"
    ...
    settings.attention_branching = True
    settings.attention_model_path = "/home/simon/dda-inputs/attention_model_1/model/attention_model_1.pt"
    settings.attention_branching_threshold = 15
    ...
    switch_times = [settings.max_time + 2.0]
    ...
    for switch_time in switch_times:
        for repetition in range(repetitions if switch_time < max_time else 1):
            ...
            while not trajectory_done:
                ...
                attention_labels.append(controller.attention_label)
            ...
            if save_data:
                save_trajectory_data(time_stamps, mpc_actions, network_actions, states, network_used, max_time,
                                     switch_time, repetition, experiment_path, attention_labels)
